...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>SuperApp</application>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Shop__c.Annual_Revenue_ppp__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Shop__c.Monkey_Image__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Shop__c.Payment_Method__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Creating_Case_To_Delivering_Products</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Price_Changing_Flow</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Products_Delivering_Flow</flow>
    </flowAccesses>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>CollaborationGroup-Supermarket Wrong Layout</layout>
        <recordType>CollaborationGroup.Wrong_Supermarket</recordType>
    </layoutAssignments>
    <layoutAssignments>
